...
class AudioGenerateService:
    ...
    # добавляем паузу между нотами для демонстрации на гистограмме
    ...
    def save_wav(self, file_name):
        ...
        wav_file.close()
        pass
    # метод вызова, где идет генерация нот и дальнейшее сохранение
    def call(self):
...
class AudioHistogram:
    def __init__(self):
        ...
        pass
    # метод наложения одной дорожки на другую с его дальнейшим сохранением
    def combine(self):
